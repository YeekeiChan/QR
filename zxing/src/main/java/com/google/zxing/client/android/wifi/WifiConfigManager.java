...
public final class WifiConfigManager extends AsyncTask<WifiParsedResult,Object,Object> {
  ...
  protected Object doInBackground(WifiParsedResult... args) {
    ...
    String networkTypeString = theWifiResult.getNetworkEncryption();//得到wifi的类型
  ...
  // Adding a WEP network 用来处理WEP的 wifi连接
  ...
  // Adding a WPA or WPA2 network 用来处理WPA的 wifi连接
